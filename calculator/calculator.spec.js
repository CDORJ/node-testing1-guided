...
describe('arithmetic functions', () => {
    describe('add()', () => {
        ...
        test('throws an exception if the parms are not numbers', () => {
        ...
        test('returns 0 when called with no args', () => {
        ...
        test('returns the param if only one is passed in', () => {
        ...
        test('returns sum of an array of numbers', () => {
            expect(add([1, 2, 3])).toBe(6);
            expect(add([1, 2, 3, 5])).toBe(11);
        })
        ...
        test.todo('should handle two or more arrays.');
